...
`kaos-office` requires Python 3.13 or newer. It publishes the `kaos_office`
import package. This package publishes CLI entry point(s): `kaos-office`, `kaos-office-serve`.
Public extras currently declared: `nlp`, `pptx`, `xlsx`, `xlsx-calamine`, `xlsx-formulas`.
...
include the `kaos-office` version, Python version, operating system,
