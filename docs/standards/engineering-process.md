...
This document defines how `kaos-office` handles features, bugs,
...
- What `kaos-office` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_office`.
